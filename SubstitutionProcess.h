...
class SubstitutionProcess : public virtual RateProcessVI, public virtual ProfileProcess, public virtual BranchProcessVI {
	...
	int GetNsite() {return RateProcessVI::GetNsite();}
	...
	virtual BranchSitePath** SamplePaths(int* stateup, int* statedown, double time) = 0;
        virtual BranchSitePath** SamplePathsVI(int* stateup, int* statedown, double timealpha, double timebeta) = 0;
